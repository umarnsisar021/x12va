...
const mapDispatchToProps = (dispatch) => {
    return {
      ...
      showFadeLoader: (data) => dispatch({ type: 'SET_FADE_LOADER', payload:, token:data.token }),
      hideFadeLoader: (data) => dispatch({ type: 'SET_FADE_LOADER', payload:, token:data.token }),
    }
  }
