...
function ExpertSkillComponent  (props) {
    ...
    if(data){
        ...
        {...props}
      >
        <rect x="15" y="49" rx="0" ry="0" width="114" height="30" /> 
        <rect x="144" y="50" rx="0" ry="0" width="114" height="30" /> 
        <rect x="276" y="50" rx="0" ry="0" width="114" height="30" /> 
        <rect x="19" y="1" rx="0" ry="0" width="77" height="24" /> 
        <rect x="17" y="35" rx="0" ry="0" width="508" height="0" /> 
        <rect x="14" y="36" rx="0" ry="0" width="468" height="2" /> 
        <rect x="393" y="9" rx="0" ry="0" width="77" height="21" />
      </ContentLoader>;
    }
