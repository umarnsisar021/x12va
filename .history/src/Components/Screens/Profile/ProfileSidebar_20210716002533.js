...
function ProfileSidebar(props) {
    ...
    return (
        <div className="profile__sidebar">
            ...
            <Link to="experts/orders"><button className="btn-theme-default btn-sm">My Order</button></Link>
            <Link to="experts/orders"><button className="btn-theme-default btn-sm">Take Skills Test</button></Link>
