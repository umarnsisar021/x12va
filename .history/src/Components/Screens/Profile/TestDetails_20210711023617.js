                ...
                <div className="refc__inner" style={{padding:'40px'}}>
                    ...
                    <div className="mt-5" id="test-details-content" style={{display:'flex',justifyContent: 'space-between'}}>
                        <div className="test-details-item">
                            <span id="test-details-item-icon" style={{background: '#066fc0',color:'white'}}><Clock /></span>
                        ...
                        <div className="test-details-item">
                            <span id="test-details-item-icon" style={{background: '#079f80',color:'white'}}><Clock /></span>
                            <span style={{ paddingTop: '3px'}}>
