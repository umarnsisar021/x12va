                        ...
                        <Modal.Body className="modal-body modal-content">
                            <div className="modal__wrapper">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <input type="text" className="mb-0" placeholder="Enter University/Institute Name" name="institute_name" defaultValue="" {...register("institute_name", { required: true })}/>
                                    {errors.institute_name && <error style={{ color: '#e87c7c', fontSize: '12px', display: 'block' }}><AlertCircle color="#e87c7c" size={12} /> This field is required</error>}
                                    <br />
                                    <input type="text" placeholder="Degree Name" name="degree" defaultValue="" {...register("degree", { required: true })}/>
                                    {errors.degree && <error style={{ color: '#e87c7c', fontSize: '12px', display: 'block' }}><AlertCircle color="#e87c7c" size={12} /> This field is required</error>}
                                    <br />
                                    <Controller
                                        control={control}
                                        defaultValue=""
                                    ...
                                    />
                                    {errors.date_from && <error style={{ color: '#e87c7c', marginTop: '7px', display: 'block' }}><AlertCircle color="#e87c7c" size={12} /> This field is required</error>}
                                    <br />
