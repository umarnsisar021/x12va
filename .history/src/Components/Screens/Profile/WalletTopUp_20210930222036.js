...
function WalletTopUp(props) {
    ...
    const onSubmitTopUp = (data)=>{
        ...
        delete data['cc-exp'];
        useJwt.post('transaction/add_payment',{...data,token:props.sessionToken}).then((res)=>{
            if(res.data){
                Swal.fire({
                    title: 'Congratulation!!!',
                    icon: 'success',
                    html:'<span style="font-size: 16px">'+res.data.message+'</span>',
                })
                                ...
                                <Number
                                    ...
                                    render={({
                                        ...
                                        return  <div className="mb-3" style={{position:'relative'}}>
                                                    <input {...register("card_no", { required: true })} {...getInputProps()} defaultValue="4242424242424242" value="4242 4242 4242 4242"  className={valid ? '' : 'error'} />
                                    ...
                                    <div className="col-md-6">
                                        <Expiration
                                            render={({
                                                ...
                                                return  <div style={{position:'relative'}}>
                                                            <input defaultValue={month} {...register("cc-exp", { required: true })} {...getInputProps()}   className={valid ? '' : 'error'} />
                                                        </div>
                                                }}
                                        />
                                    </div>
