            ...
            <div className="wrapper__main">
                ...
                <div className="refc__inner px-4 py-4">
                    <div className="text-center">
                        <img className="py-2" src={CongAvatar} style={{height:'80px'}} />
                        <h5 className="py-2">ORDER STARTED</h5>
                ...
                {/* ORDER STARTED */}
                {
                    Object.values(data.updates).map((u)=>{
                        return  <div className="refc__inner px-4 py-4">
                                    <div className="text-center">
                                        <img className="py-2" src={CongAvatar} style={{height:'80px'}} />
                                        <h5 className="py-2">HERE'S YOU DELIVERY!</h5>
                                        
                                    </div>
                                    <div className="d-flex justify-content-between">
                                        <div className="d-flex align-items-center">
                                            <div>
                                                <Avatar round size={35} src={data.client.avatar}/>
                                            </div>
                                            <div className="pl-2">
                                                <h6 className="f-12">{data.client.name}</h6>
                                                <h6 className="color-gray f-12"><Moment format="MMM DD, YYYY">{data.task_detail.created_at}</Moment></h6>
                                            </div>
                                        </div>
                                        <div>
                                            <h6>{data.task_detail.days > 1 ? data.task_detail.days+" Days" : data.task_detail.days+" Day" }</h6>
