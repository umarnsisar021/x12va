                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="tOrder__inner my-3" >
                            ...
                            <div className="text-center">
                                ...
                                <input type="submit" value="0" {...register("is_final_delivery",{required:true})} className="btn-theme-default button btn-sm mx-1" style={{alignSelf:'center'}}>Final Deliver</button>
                            </div>
