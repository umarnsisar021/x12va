...
import { ArrowDownCircle,AlertCircle ,Clock,CheckCircle, ChevronsDown} from 'react-feather';
                        ...
                        return  <div className="refc__inner px-4 py-4 my-3">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <p>Delivered File</p>
                                            <span>
                                                <p className="">{ u.document ? u.document.replace(/^.*[\\\/]/, '') : ''} <ArrowDownCircle className="pointer" onClick={()=>{
