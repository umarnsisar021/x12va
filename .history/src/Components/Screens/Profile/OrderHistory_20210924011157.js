...
const UpdateCommentComponent = (props)=>{
    ...
    const [inputText,setInputText] = useState(props.comments) 
}
                                    ...
                                    <div>
                                        ...
                                        {   
                                            ...
                                            <div className="o-u-c-i-container">
                                                <input onFocus={inputOnHover} onBlur={inputOnBlur} className="" />
                                                <button onClick={()=>handeleSubmitComment(u.id)} className="btn-theme-default py-0 f-12" style={{height:30}} type="submit">Submit</button>
                                            </div>  
                                            :
                                            null 
                                        }
