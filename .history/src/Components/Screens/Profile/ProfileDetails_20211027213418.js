...
function ProfileDetails(props) {
    CropLandscapeOutlined.log(props.userData)
    return (
        <div className="profile__details">
            ...
            <div className="contact__detailsBio">
                ...
                <hr/>
                <div className="d-flex contact__details_container" style={{justifyContent:'space-around',textAlign: 'center',padding:'15px 10px 30px 10px'}}>
                    <div className="cdc_row">
                        <div>Mobile Number</div>
                        <div className="f-14" style={{fontWeight:500}}>(456) 6543456</div>
                    </div>
                    <div className="cdc_row">
                        <div>Email Address</div>
                        <div className="f-14" style={{fontWeight:500}}>{props.userData.email}</div>
                    </div>
                </div>
            </div>
