...
function ExpertSkillComponent  (props) {
    ...
    const handleDeleteSkill = (id)=>{
        useJwt.post("experts/delete_expert_skill",{id:id}).then((res)=>{
            MySwal.fire({
                title: <p>The skill deleted.</p>,
        ...
        return (
            <div className="skills__sec">
                <div className="skillsInner__sec">
                    ...
                    <Link to="/expert/skill/create"><button className="buttontype2" >Add New</button></Link>
                </div>
                <hr/>
