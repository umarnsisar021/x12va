...
const dataToRender = () => {
    ...
    if(loaded){
        let time =  moment().add(data.task_detail.days, 'days').format('MMMM Do YYYY, h:mm:ss a');
        time =  moment('2021-07-25T20:04:27.000000Z').add(data.task_detail.days, 'days').format('MMMM Do YYYY, h:mm:ss a');
        return (
        <React.Fragment>
            {time}
            <div className="wrapper__main">
                ...
                <div className="refc__inner px-4 py-4">
                    ...
                    {
                        data.task_detail.days
                    }
                    <Countdown timeTillDate="10 01 2021" timeFormat="MM DD YYYY, h:mm a" />
                </div>
                {/* ORDER STARTED */}
