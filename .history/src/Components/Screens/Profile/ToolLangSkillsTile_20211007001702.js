...
export function SkillsTile(props) {
    ...
    return (
        <span className="toolLangSkills">
            ...
            { 
                props.status == 0 ?
                <span className="icon-give-test" onClick={props.onDelete} style={{paddingLeft:'5px',paddingRight:'5px',float:'right' , borderLeft: "1px solid #D3D3D3"}}><Edit3 size={14}/></span>
                : null
            }
            {
