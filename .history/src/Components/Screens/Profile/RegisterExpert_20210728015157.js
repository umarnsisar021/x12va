...
function RegisterExpert(props) {
    ...
    //   };
      ...
      const HandleOnSubmit = (data) => {
        ...
        useJwt.post('experts/register_without_reference_code',data).then((res)=>{
            if(res.data.status !== 400){
                props.showFadeLoader('Redirecting to skill selection.');
                ...
                setTimeout(()=>{
                    ...
                    history.push('/expert/skill/create')
                },1500)
            }
            else{
...
export default connect(mapStateToProps,mapDispatchToProps)(RegisterExpert)
