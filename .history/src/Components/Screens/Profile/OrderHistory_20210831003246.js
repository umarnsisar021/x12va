            ...
            <div className="wrapper__main">
                ...
                <div className="refc__inner px-4 py-4">
                    <div className="d-flex justify-content-between">
                        <h4 className="font-weight-bold">Order ID # 21</h4>
                        <h4 className="font-weight-bold">$200.00</h4>
                    </div>
                    <div className="d-flex justify-content-between">
                        <div className="d-flex">
                            <div>
                                <div></div>
                                <Avatar round size={60} src="https://x12va.s3.ap-south-1.amazonaws.com/avatars/umarnisar021-28.png"/>
                            </div>
                            <div>
                                <h6 className="f-w-500">radiofreedotorg</h6>
                                <h6 className="f-w-500">June 29, 2021</h6>
                            </div>
                        </div>
                    </div>
                </div>
