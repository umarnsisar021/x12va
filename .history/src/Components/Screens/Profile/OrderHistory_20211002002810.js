...
const dataToRender = () => {
    ...
    if(loaded){
        let time =  moment(data.task_detail.start_time).add(data.task_detail.days, 'days').format('MMMM Do YYYY, h:mm:ss a');
        ...
        <React.Fragment>
            <div className="wrapper__main">
                ...
                <div className="refc__inner px-4 py-4">
                    ...
                    <CountdownMonths targetTime="2021-12-03 10:30 am"/>
                </div>
                {/* ORDER STARTED */}
