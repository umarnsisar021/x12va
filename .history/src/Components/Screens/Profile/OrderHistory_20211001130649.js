    ...
    if(loaded){
        ...
        <React.Fragment>
            <div className="wrapper__main">
                ...
                <UpdateOrderFile  data={data} userData={props.userData} sessionToken={props.sessionToken} showFadeLoader={props.showFadeLoader} hideFadeLoader={props.hideFadeLoader}  />
