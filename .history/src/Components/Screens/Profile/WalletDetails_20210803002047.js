        ...
        <React.Fragment>
            <div className="wrapper__main">
                <EverySectionHeader
                    title="My Wallet"
                />
                <div className="refc__inner px-4 py-2">
                    <div className>
                        <h5 className="mb-0 d-inline-block" style={{fontWeight:700}}>Balance &nbsp; &nbsp; $200</h5>
                        <div className="float-right d-inline-block"><Link className="btn-theme-default btn-sm">TopUp</Link></div>
                    </div>
