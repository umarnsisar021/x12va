                ...
                {/* ORDER STARTED */}
                {
                    Object.values(data.updates).map((u,u_index)=>{
                        return  <div className="refc__inner px-4 py-4 my-3">
                                    ...
                                    <div>
                                        <h6>COMMENTS</h6>
                                        <UpdateCommentsComponent key={u_index} update_id={u.id} comments={u.comments} client={data.client} expert={data.expert} userData={props.userData} sessionToken={props.sessionToken} />
                                    </div>    
                                </div>
                    })
                }
...
function mapStateToProps(state) {
    ...
    return { userData : auth.userData,sessionToken : auth.sessionToken ,skillsData : skills.skillsData ,account_mode}
  }
