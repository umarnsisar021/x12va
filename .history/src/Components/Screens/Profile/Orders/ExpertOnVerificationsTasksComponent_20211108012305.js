...
const OnVerifyingOrders = (props) => {
  ...
  React.useEffect(()=>{
    ...
    useJwt.post('experts/get_client_tasks',{status:3,token:token}).then((res)=>{
...
export default connect(mapStateToProps,mapDispatchToProps)(OnVerifyingOrders)
