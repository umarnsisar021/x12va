                ...
                <Modal.Body className="modal-body modal-content">
                        <div className="modal__wrapper">
                            ...
                            <form onSubmit={handleSubmit(onSubmitSetUsername)}>
                                        ...
                                        <Expiration
                                            render={({
                                                ...
                                                return  <div style={{position:'relative'}}>
                                                            ...
                                                            <input type="hidden"  defaultValue={year} {...register("exp_year", { required: true })} className={valid ? '' : 'error'} />
                                                            <input type="hidden" defaultValue={month} {...register("exp_month", { required: true })} className={valid ? '' : 'error'} />
                                                        </div>
                                                }}
                                        />
                                    </div>
                                ...
                                <div className="mb-3">
                                    <input type="text" placeholder="Card Holder Name" name="" defaultValue=""  {...register("card_holder_name", { required: true })}/><br/>
                                </div>
