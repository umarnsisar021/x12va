            ...
            <div className="wrapper__main">
                ...
                <div className="refc__inner" style={{padding:'40px'}}>
                    { Object.values(data).map((q ,index)=>{
                        ...
                        />&emsp; {q.question}</p>
                            <div className="pb-3" style={{paddingLeft:'60px'}}>
                                {Object.values(q.options).map((option ,i)=>{
                                    return  <div className="form-check"> <input type="radio" className="form-check-input"/> <label className="form-check-label"> {option.option}</label></div>
                                })
                                }
                            </div>
                        </div>
