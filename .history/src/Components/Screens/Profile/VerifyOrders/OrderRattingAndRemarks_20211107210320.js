                            ...
                            <div className=" text-center mt-3">
                                    ...
                                    <div>
                                        <div  className="d-flex align-items-center justify-content-center" style={{fontSize:'60px'}} >
                                            <div>
                                                <input className="p-0" style={{width:'40px',border:'none',fontSize:'60px !important'}} placeholder="0" id="ratting-input" />
                                            </div>
                                            <div className="">
                                                / 10
                                            </div>
...
var input = document.querySelector('#ratting-input'); // get the input element
input.addEventListener('#ratting-input', resizeInput); // bind the "resizeInput" callback on "input" event
resizeInput.call(input); // immediately call the function
function resizeInput() {
  alert(this.value.length + "ch";)
