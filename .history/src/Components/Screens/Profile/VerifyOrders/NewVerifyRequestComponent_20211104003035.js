    ...
    const acceptRequest = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                useJwt.post('tasks/accept_verification_request',{task_id:id,token:props.sessionToken}).then((res)=>{
    ...
    const columns = [
        ...
        },
        {
                ...
                cell: row => (<div className="pl-2" style={{justifyContent: 'end'}}>
                                <button onClick={()=>acceptRequest(row.id)} className="btn-theme-light btn-sm">
                                    Accept
                                </button>
                            </div>)
            },
