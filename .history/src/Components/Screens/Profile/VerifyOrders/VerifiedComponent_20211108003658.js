...
function CompletedTasksComponent(props) {
    ...
    React.useEffect(()=>{
        useJwt.post('experts/get_verify_completed', {page: currentPage, perPage: rowsPerPage, token: props.sessionToken,status:4 }).then((res)=>{
...
export default connect(mapStateToProps,mapDispatchToProps)(CompletedTasksComponent)
