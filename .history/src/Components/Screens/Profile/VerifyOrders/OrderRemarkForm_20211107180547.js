                    ...
                    <div className="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                {/*  */}
                                    <div className="f-14 mt-4      ">
                                        <p className="m-0"><span>Skill :</span> {data.task_detail.skill_name}</p>
                                    </div>
                                    <div className="pt-2 f-14">
                                        <p className="m-0"><span></span> {data.task_detail.description}</p>
                                    </div>
                                    <div className="pt-2">
                        ...
                        <div className="d-flex align-items-center" style={{width:'49%'}}>
                               ...
                               <div>
                                ...
                                {/*  */}
                                    <div className="f-14 mt-4      ">
                                        <p className="m-0"><span>Problem Statement :</span> {data.proposal.problem_statement}</p>
                                    </div>
                                    <div className="pt-2 f-14">
                                        <p className="m-0"><span>Description :</span> {data.proposal.description}</p>
                                    </div>
                                    <div className="pt-2">
                                        <p className="">{ data.task_detail.document ? data.task_detail.document.replace(/^.*[\\\/]/, '') : ''}  
                                            <ArrowDownCircle className="pointer ml-1" size={18} onClick={()=>{
