                            ...
                            <div className=" text-center mt-3">
                                    ...
                                    <div>
                                        <div  className="d-flex align-items-center justify-content-center" style={{fontSize:'60px'}} >
                                            <div> 
                                                <input className="p-0" style={{width:'40px',border:'none',}} placeholder="0" type="number"  id="ratting-input" onKeyPress={(elem)=>elem.target.style.width = ((this.value.length + 1) * 8) + 'px'} />
                                            </div>
                                            <div className="">
                                                /&nbsp; 10
                                            </div>
