                ...
                <div className="refc__inner" style={{padding:'40px'}}>
                    ...
                    <div className="mt-5" id="test-details-content" style={{display:'flex',justifyContent: 'space-between'}}>
                        <div id="test-details-item">
                            <span id="test-details-item-icon" style={{background: 'gray',borderRadius: '50%',textAlign: 'center',
    justifyContent: 'center',
    verticalAlign: 'middle',
    alignItems: 'center',
    width: '60px',
    height: '60px',
    display: 'grid',}}><Clock /></span>
                        </div>
                        <div>
                            <span style={{    background: 'gray',borderRadius: '50%',textAlign: 'center',
    justifyContent: 'center',
    verticalAlign: 'middle',
    alignItems: 'center',
    width: '60px',
