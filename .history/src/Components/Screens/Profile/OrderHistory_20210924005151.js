                                    ...
                                    <div>
                                        ...
                                        {   
                                            ...
                                            <div className="o-u-c-i-container">
                                                <input onFocus={()=>{inputOnHover()}}  className="" />
                                                <button className="btn-theme-default py-0 f-12" style={{height:30}} type="submit">Submit</button>
                                            </div>  
                                            :
                                            null 
                                        }
...
function mapStateToProps(state) {
  ...
  function inputOnHover() {
    var x = document.getElementsByClassName("o-u-c-i-container").parentElement.nodeName;
    document.addClassList("hover")
  }
