                ...
                <form action="" onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                    <div className="rfcUser__details">
                        <div className="rfcInput__box">
                            ...
                            <input defaultValue="" autoComplete="off"  {...register("first_name",{required:true})} type="text" placeholder="First Name" />
                        ...
                        <div className="rfcInput__box">
                            <span>Last Name</span>
                            <input defaultValue="" autoComplete="off" {...register("last_name",{required:true})} type="text" placeholder="Last Name" />
                        ...
                        <div className="rfcInput__box">
                            <span>Username</span>
                            <input defaultValue="" autoComplete="off" {...register("username",{required:true})} type="text" placeholder="username" />
