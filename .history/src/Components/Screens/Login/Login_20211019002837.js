        ...
        >
            <Modal.Body className="modal-body modal-content">
                <div className="modal__wrapper">
                    ...
                    <h2>Sign In to {props.siteConfig.company_name}</h2>
                    <form onSubmit={handleSubmit(onSubmitLogin)} autoComplete={"off"}>
                        <input type="text" placeholder="Email Address"  defaultValue="" {...register("email", { required: L_R_email })} autoComplete="off" />
                        {errors.email && <span>This field is required</span>}<br/>
                        <input type="password" placeholder="Password" defaultValue="" {...register("password", { required: L_R_password })} autoComplete="off" /><br/>
        ...
        >
            <Modal.Body className="modal-body modal-content">
                <div className="modal__wrapper">
                    ...
                    <h2>Join {props.siteConfig.company_name}</h2>
