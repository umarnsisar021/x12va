            ...
            <Modal.Body className="modal-body modal-content">
                <div className="modal__wrapper">
                    ...
                    <form onSubmit={handleSubmit(onSubmitLogin)}>
                        <input type="text" placeholder="Email Address" name="email" defaultValue="" {...register("email", { required: true })}/><br/>
                        <input type="password" placeholder="Password" name="password" defaultValue="" {...register("password", { required: true })} /><br/>
