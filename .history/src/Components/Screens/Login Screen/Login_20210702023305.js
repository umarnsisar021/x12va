...
function Login( props ) {
    ...
    const [SignUpfield_username , setSignUpfield_username] = React.useState(false);
    const [SignUpfield_password , setSignUpfield_passworde] = React.useState(false);
            ...
            <Modal.Body className="modal-body modal-content">
                <div className="modal__wrapper">
                    ...
                    <form onSubmit={handleSubmit(onSubmitLogin)}>
                        <input type="text" placeholder="Email Address"  defaultValue="" {...register("email", { required: true })}/>
                        {errors.email && <span>This field is required</span>}<br/>
                        <input type="password" placeholder="Password" defaultValue="" {...register("password", { required: true })} /><br/>
