            ...
            <ul className="profile__ul">
                ...
                </li>
                {
                    props.userData.is_seller == 1 ?
                        props.account_mode === 'client' ?
                        <li className="profile__li" onClick={props.onClick}>
                            <a href="javascript:void(0);" onClick={()=> {props.switch('expert');history.push("/profile")}}>
                                <ExitToAppIcon />
                                Switch to Expert
                            </a>
                        </li> : <li className="profile__li" onClick={props.onClick}>
                            <a href="javascript:void(0);" onClick={()=> {props.switch('client');history.push("/cprofile?self=true")}}>
                                <ExitToAppIcon />
                                Switch to Client
                            </a>
                        </li>
