...
function NotifyDropdown(props) {
    ...
    const HandleViewNotification = (notification) =>{
        ...
        if(notification.type == 1){
            ...
            history.push('/experts/verify/orders/new'+notification.primary_id)
        }
        //props.onClick();
    }
                                ...
                                <li className={notification.view == 1 ? 'read':'un-read'} onClick={()=>{HandleViewNotification(notification)}}>
                                    <div className="notify__icon">
                                        <span className="icon">
                                            ...
                                            {
                                                Object.keys(notification.from).length > 0 ? <img className="notification-img" src={notification.from.avatar ? notification.from.avatar : default_profile} /> :  <Bell color="#808080" />
                                            }
