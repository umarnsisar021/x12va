...
import ExpertSkillForm from './Components/Screens/UserReferenceCode/ExpertSkillForm';
...
import ClientOrders from './Components/Screens/Profile/ClientProfileComponents/ClientOrders'
    ...
    return(
      ...
      <BrowserRouter>       
        <Switch>
          ...
          <AuthRoute path="/expert/create/skillform" exact>
            <Navbar
              cName="navbar__color"
            />
            <ExpertSkillForm/>
