...
import OrderRemarkForm from '@screens/Profile/VerifyOrders/OrderRemarkForm'
    ...
    return(
      ...
      <BrowserRouter>       
        <Switch>
          ...
          {/*  */}
          <AuthRoute path="/experts/verify/orders/:type" exact>
            <Navbar
              cName="navbar__color"
            />
            <VerifyOrders />
          ...
          <AuthRoute path="/experts/order/verify/:task_id" exact>
            <Navbar cName="navbar__color" />
            <OrderHistory />
          </AuthRoute>
